...
$utilizadores = [];
$uti = $pdo->query("SELECT *FROM usuarios WHERE acesso != 'Cliente' ORDER BY id");
if ($uti->rowCount() > 0) {
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="utilizadores.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3"
                ...
                <a href="utilizadoresrl.php" style=" margin:1%; background-color:white; color:rgb(230,54,115);"><button style="background-color:white; color:rgb(230,54,115); border-color:white; border-radius:4px;"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Relatório</button></a>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-left mb-0">
                  ...
                  <?php foreach ($utilizadores as $lista): ?>
                    <tbody>
                      <tr>
                        ...
                        <td class="align-middle" style="display: flex; justify-content: space-around;">
                          <a href="editaruser.php?id=<?= $lista['id'] ?>" class="text-secondary font-weight-bold text-xs"
                            data-toggle="tooltip" title="Editar categoria"><i class="fa fa-pencil"
                              aria-hidden="true"></i></a>
                          <a href="excluir.php?id=<?= $lista['id'] ?>" class="text-secondary font-weight-bold text-xs"
                            data-toggle="tooltip" data-original-title="Eliminar Categoria"><i class="fa fa-trash"
                              aria-hidden="true"></i></a>
                        </td>
                      </tr>
                    </tbody>
        ...
        <form action="novouser_action.php" method="post" class="registrar">
          <div class="d-flex justify-content-around flex-wrap text-center">
            <div class="mb-3">
              ...
              <input type="text" name="username" placeholder="Nome de usuário" class="form-control text-center border"
                aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Nome*</label>
              <input type="text" name="pnome" placeholder="Primeiro nome" class="form-control text-center border"
                aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Apelido*</label>
              <input name="unome" placeholder="Último nome" id="verpass" type="text"
          ...
          <div class="d-flex justify-content-around flex-wrap text-center">
            <div class="mb-3">
              ...
              <input type="email" name="email" placeholder="Seu email" class="form-control text-center border"
                text-center aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Telefone*</label>
              <input type="number" name="telefone" placeholder="+244" class="form-control text-center border"
                aria-describedby="emailHelp">
            </div text-center>
            <div class="mb-3">
              <label for="">
              ...
              <input min="<?php echo date('Y-m-d', strtotime('-50 year')); ?>"
                max="<?php echo date('Y-m-d', strtotime('-18 year')); ?>" name="nasc" placeholder="Data de nascimento"
                id="verpass" type="date" class="form-control text-center border">
            </div>
          </div>
          <div class="d-flex justify-content-around flex-wrap text-center">
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Gênero*</label><br>
              <select name="genero" style="border-radius: 4px;" placeholder="Gênero" style="margin: text-center 1%;">
            ...
            <div class="mb-3" text-center>
              ...
              <input name="senha" placeholder="Sua senha" id="verpass" type="password"
                class="form-control text-center border">
            </div>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Confirmar senha*</label>
              <input name="confsenha" placeholder="Repetir senha" id="verpass" type="password"
                class="form-control text-center border">
            </div>
          </div>
          <div class="d-flex justify-content-around flex-wrap text-center">
            <div class="mb-3">
              ...
              <select name="acesso" style="border-radius: 4px; margin:1%;">
                <option value="Gerente">Selecionar</option>
