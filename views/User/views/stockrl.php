...
$dados .= '				
  ...
  <div>
  <div class="text-center"><h2 class="text-center">RELATÓRIO DOS PRODUTOS EM STOCK</h2></div>
	<div>
		<h6>Dashboard >> Stock >> Relatório</h6>
		<h6>Relatório: Produtos em Stock</h6>
...
$dompdf->render();
$dompdf->stream('Relatório-dos-produtos-em-stock.pdf');
?>