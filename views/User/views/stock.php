...
$produtos = [];
$prod = $pdo->query("SELECT *FROM produtos, categorias WHERE produtos.categoria = categorias.id_categoria AND estado_prod = 'Em stock' ORDER BY id_prod");
if ($prod->rowCount() > 0) {
  $produtos = $prod->fetchALL(PDO::FETCH_ASSOC);
}
$valor_total_stock = $pdo->prepare("SELECT SUM(quantidade_prod * preco_compra) AS valor_stock FROM produtos");
$valor_total_stock->execute();
$custo_stock = $valor_total_stock->fetch(PDO::FETCH_ASSOC);

$valor_total_venda = $pdo->prepare("SELECT SUM(quantidade_prod * preco_prod) AS valor_venda FROM produtos");
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="stock.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="row">
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder">Custo total dos produtos em Stock
              </p>
            </div>
          </div>
        </div>
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder">Total da venda dos produtos em Stock
              </p>
            </div>
          </div>
        </div>
        <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder">Lucro estimado</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3"
                ...
                <a href="stockrl.php" style=" margin:1%; background-color:white; color:rgb(230,54,115);"><button
