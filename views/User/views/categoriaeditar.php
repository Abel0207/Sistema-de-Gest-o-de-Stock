        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body text-center px-0 pb-2">
              <form action="categoriaeditar_action" method="post" class="registrar  text-center">
                <div class="cad">
                  <input type="text" name="id_categoria" hidden value="<?php echo $categorias['id_categoria']; ?>">
                  <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Categoria*</label>
                    <input type="text" name="nome_categoria" value="<?php echo $categorias['nome_categoria'] ?>"
