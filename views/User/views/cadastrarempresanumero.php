          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3" style="padding-left: 2%;">
                <h4 style="color: white;">Número de telefone principal da Empresa?</h4>
              </div>
            </div>
                ...
                <form method="POST" class="registrar">
                  <div class="modal-body">
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      if ($nome_empresa) {
                        $sql = $pdo->prepare("SELECT *FROM ramos WHERE nome_empresa = :nome_empresa AND numero_empresa = :numero_empresa");
                        $sql->bindValue(':nome_empresa', $nome_empresa);
                        $sql->bindValue(':numero_empresa', $numero_empresa);
                        $sql->execute();

                        if ($sql->rowCount() === 0) {
                          echo '<div class="text-success" id="erroLogin">*O senhor será redirecionado para um outro formulário.<button type="button" class="close" onclick="fecharErroLogin()"><span>&times;</span></button></div>';
                          echo "<script>setTimeout(function(){ window.location.href = 'cadastrarempresaemail.php?nome_empresa=$nome_empresa&numero_empresa=$numero_empresa';}, 3000);</script>";
                          exit();
                        } else {
                          echo '<div class="text-danger" id="erroLogin">*Esta empresa já foi cadastrada, tente escolher outra.<button type="button" class="close" onclick="fecharErroLogin()"><span>&times;</span></button></div>';
                          exit();
                        }
                      } else {
                    ...
                    <div class="col-md-6 text-center" style="margin: 5px; width: 100%;">
                      ...
                      <center><input
                          style="border-radius: 4px; width: 40%; height: 20%; padding: 2%; overflow:hidden; border: solid 2px;"
                          type="text" name="numero_empresa" minlength="9" maxlength="9"
                          onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder="Tel."
                          class="form-control" required aria-describedby="emailHelp"></center>
